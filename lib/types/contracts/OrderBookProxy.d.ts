...
export type OrderBookProxyConfigurables = Partial<{
    INITIAL_OWNER: StateInput;
    INITIAL_TARGET: ContractIdInput;
}>;
export declare class OrderBookProxyInterface extends Interface {
    constructor();
    functions: {
...
export declare class OrderBookProxy extends __Contract {
    static readonly abi: {
        programType: string;
        specVersion: string;
