...
export type AddBlacklistEventInput = { trader: ContractIdInput };
export type AddBlacklistEventOutput = { trader: ContractIdOutput };
...
export type RemoveBlacklistEventInput = { trader: ContractIdInput };
export type RemoveBlacklistEventOutput = { trader: ContractIdOutput };

export type TradeAccountBlacklistConfigurables = Partial<{
...
export class TradeAccountBlacklistInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class TradeAccountBlacklist extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: TradeAccountBlacklistInterface;
  declare functions: {
    blacklist: InvokeFunction<[trader: ContractIdInput], void>;
    initialize: InvokeFunction<[], void>;
    remove_blacklist: InvokeFunction<[trader: ContractIdInput], void>;
