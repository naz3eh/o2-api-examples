...
export type AddBlacklistEventInput = { trader: IdentityInput };
export type AddBlacklistEventOutput = { trader: IdentityOutput };
...
export type RemoveBlacklistEventInput = { trader: IdentityInput };
export type RemoveBlacklistEventOutput = { trader: IdentityOutput };
...
export class OrderBookBlacklistInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class OrderBookBlacklist extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: OrderBookBlacklistInterface;
  declare functions: {
