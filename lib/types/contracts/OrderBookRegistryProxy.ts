...
export class OrderBookRegistryProxyInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class OrderBookRegistryProxy extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: OrderBookRegistryProxyInterface;
  declare functions: {
