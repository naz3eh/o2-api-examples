...
exports.MinHeapTest = exports.MinHeapTestInterface = void 0;
...
const storageSlots = [];
class MinHeapTestInterface extends fuels_1.Interface {
    constructor() {
        super(abi);
    }
}
exports.MinHeapTestInterface = MinHeapTestInterface;
class MinHeapTest extends fuels_1.Contract {
    static abi = abi;
...
exports.MinHeapTest = MinHeapTest;
