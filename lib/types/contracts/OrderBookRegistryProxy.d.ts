...
export type OrderBookRegistryProxyConfigurables = Partial<{
    INITIAL_OWNER: StateInput;
    INITIAL_TARGET: ContractIdInput;
}>;
export declare class OrderBookRegistryProxyInterface extends Interface {
    constructor();
    functions: {
...
export declare class OrderBookRegistryProxy extends __Contract {
    static readonly abi: {
        programType: string;
        specVersion: string;
    ...
    interface: OrderBookRegistryProxyInterface;
    functions: {
...
//# sourceMappingURL=OrderBookRegistryProxy.d.ts.map