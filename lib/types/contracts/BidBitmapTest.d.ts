...
export declare class BidBitmapTestInterface extends Interface {
    constructor();
    functions: {
...
export declare class BidBitmapTest extends __Contract {
    static readonly abi: {
        programType: string;
        specVersion: string;
