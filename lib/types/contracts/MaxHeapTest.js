...
exports.MaxHeapTest = exports.MaxHeapTestInterface = void 0;
...
const storageSlots = [];
class MaxHeapTestInterface extends fuels_1.Interface {
    constructor() {
        super(abi);
    }
}
exports.MaxHeapTestInterface = MaxHeapTestInterface;
class MaxHeapTest extends fuels_1.Contract {
    static abi = abi;
...
exports.MaxHeapTest = MaxHeapTest;
