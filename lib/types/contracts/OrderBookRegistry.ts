...
export enum OrderBookRegistryErrorInput {
  MarketAlreadyHasOrderBook = 'MarketAlreadyHasOrderBook',
  InvalidPair = 'InvalidPair',
}
export enum OrderBookRegistryErrorOutput {
  MarketAlreadyHasOrderBook = 'MarketAlreadyHasOrderBook',
  InvalidPair = 'InvalidPair',
}
...
export type MarketIdInput = { base_asset: AssetIdInput; quote_asset: AssetIdInput };
export type MarketIdOutput = { base_asset: AssetIdOutput; quote_asset: AssetIdOutput };
export type OrderBookRegisteredInput = { contract_id: ContractIdInput; market_id: MarketIdInput };
export type OrderBookRegisteredOutput = { contract_id: ContractIdOutput; market_id: MarketIdOutput };
...
export type PageInput<T> = { items: Vec<T>; page: BigNumberish; total: BigNumberish };
export type PageOutput<T> = { items: Vec<T>; page: BN; total: BN };
export type PauseEventInput = { caller: IdentityInput };
export type PauseEventOutput = { caller: IdentityOutput };
export type UnpauseEventInput = { caller: IdentityInput };
export type UnpauseEventOutput = { caller: IdentityOutput };
...
export class OrderBookRegistryInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class OrderBookRegistry extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: OrderBookRegistryInterface;
  declare functions: {
    ...
    register_order_book: InvokeFunction<
      [contract_id: ContractIdInput, market_id: MarketIdInput],
