...
export type TradeAccountRefererInput = { trade_account: ContractIdInput; referer: IdentityInput };
export type TradeAccountRefererOutput = { trade_account: ContractIdOutput; referer: IdentityOutput };
export type TradeAccountRegisteredInput = { contract_id: ContractIdInput; owner: IdentityInput };
export type TradeAccountRegisteredOutput = { contract_id: ContractIdOutput; owner: IdentityOutput };
...
export class TradeAccountRegistryInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class TradeAccountRegistry extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: TradeAccountRegistryInterface;
  declare functions: {
    ...
    register_contract: InvokeFunction<
      [child_contract: ContractIdInput, configurables?: Option<Vec<[BigNumberish, Vec<BigNumberish>]>>],
